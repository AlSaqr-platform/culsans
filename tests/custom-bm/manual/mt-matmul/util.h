...
#define stats(code, iter) do { \
    ...
    if (cid == 0) { \
      put_string("\n"); \
      put_uint64(_c); put_string(" cycles, "); \
      put_uint64(_c/iter); put_string("."); put_uint64(10*_c/iter%10); put_string(" cycles/iter, "); \
      put_uint64(_c/_i); put_string("."); put_uint64(10*_c/_i%10); put_string(" CPI\n"); } \
  } while(0)
