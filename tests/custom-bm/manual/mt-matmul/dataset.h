...
typedef int data_t;static data_t input1_data[ARRAY_SIZE] __attribute__((section(".cache_share_region"))) =
{
...
static data_t input2_data[ARRAY_SIZE] __attribute__((section(".cache_share_region"))) =
{
...
static data_t verify_data[ARRAY_SIZE] __attribute__((section(".cache_share_region"))) =
{
